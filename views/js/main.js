...
function updatePositions() {
  ...
  // Extrapolate calculation outside of for loop to reduce redundant work
  var scrollAmount = document.body.scrollTop / 1250;
  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin(scrollAmount + (i % 5));
    // Utilize translate since it has better performance than style changes
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < 10; i++) {
    ...
    // Extrapolate CSS properties to reduce workload
